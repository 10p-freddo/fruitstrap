...
const CFStringRef get_device_hardware_name(const AMDeviceRef device) {
    ...
    GET_FRIENDLY_MODEL_NAME(model, "N88AP", "iPhone 5 (Global/CDMA)")
    GET_FRIENDLY_MODEL_NAME(model, "N88AP", "iPhone 5c (GSM)")
    GET_FRIENDLY_MODEL_NAME(model, "N88AP", "iPhone 5c (Global/CDMA)")
    GET_FRIENDLY_MODEL_NAME(model, "N88AP", "iPhone 5s (GSM)")
    GET_FRIENDLY_MODEL_NAME(model, "N88AP", "iPhone 5s (Global/CDMA)")
